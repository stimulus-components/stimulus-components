...
- [#218](https://github.com/stimulus-components/stimulus-components/pull/218) [`e0e7658`](https://github.com/stimulus-components/stimulus-components/commit/e0e7658614f2c04ee819945a0da3c4bc447c1b7d) Thanks [@guillaumebriday](https://github.com/guillaumebriday)! - Use `window.scrollY` instead of the deprecated `window.pageYOffset`.
