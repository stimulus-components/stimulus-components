...
- [#219](https://github.com/stimulus-components/stimulus-components/pull/219) [`fe44bfe`](https://github.com/stimulus-components/stimulus-components/commit/fe44bfe46821edfa760a076c6607d7ceb9d37561) Thanks [@guillaumebriday](https://github.com/guillaumebriday)! - Add a `count-unit` value to choose how characters are counted: `code-units` (default, unchanged behaviour), `code-points`, or `graphemes` so that composed emojis count as a single character.
